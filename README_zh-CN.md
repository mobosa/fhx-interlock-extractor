...
FHX Interlock Extractor 是一款专为 **Emerson DeltaV 系统工程师** 设计的工具，用于从 FHX 配置文件中提取联锁信息并生成结构化的 Excel 报告。它能解析 DeltaV FHX 文件，提取 Permissive、Interlock 和 Fault Handler 配置。
...
| **Fault Handler 提取** | 提取 Fault Handler 定义和故障状态 |
...
| **Fault Handler** | Fault Handler 定义及状态 |
